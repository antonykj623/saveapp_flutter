 ...
 return Card(
   ...
   child: Container(
     child: Column(
             ...
             Padding(
               ...
               child: TextButton(onPressed: (){
                 Map<String, dynamic> accountsetupData = {
                  // "id":items[0],
                   "Accountname": dat['Accountname'].toString(),

                   "catogory": dat['Accounttype'].toString(),
      ...
      Navigator.push(context,MaterialPageRoute(builder:(context)=>Editaccount(keyid:item['keyid'].toString(),year:'${currentYear}', accname: accountsetupData['Accountname'], cat: accountsetupData['catogory'], obalance: accountsetupData['Amount'], actype:accountsetupData['Type'], )));
