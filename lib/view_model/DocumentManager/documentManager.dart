...
Future<void> getDocumentFromServer({
  ...
  try {
    ...
    if (response.statusCode == 200) {
      ...
      if (jsonResponse['status'] == 1 && jsonResponse['data'] != null) {
        ...
        final documentUrl = 'https://mysaving.in/uploads/user_documents/$fileName';
        ...
        if (fileResponse.statusCode == 200) {
          ...
          await Share.shareXFiles([XFile(filePath)], text: 'Here is the document.');

        } else {
          print("Failed to download the document. Status: ${fileResponse.statusCode}");
        }
      } else {
        print("Failed or invalid response: ${jsonResponse['message']}");
      }
    } else {
      print("Failed to fetch document filename. Status: ${response.statusCode}");
    }
  } catch (e) {
...
class _Home_ScreenState extends State<Documentmanager> {
  ...
  Future<void> getfileid(File imageFile) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    String? token = prefs.getString('token');
    final url = Uri.parse('https://mysaving.in/IntegraAccount/api/uploadUserDocuments.php');
  ...
  void updateDoc(File fileToUpload) async {
    ...
    var uri = Uri.parse("https://mysaving.in/IntegraAccount/api/updateUserDocuments.php?timestamp=$timestamp"); // Replace with your actual URL
                  ...
                  children: [
                    ...
                    TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        hintText: _fileName.isNotEmpty ? _fileName : "No file selected",
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        //       final fileid = fileId; // ⬅️ now fileId will be available here
                        //
  ...
  Card(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text("Name: ${dataJson['doc'] ?? 'N/A'}",
                            style: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                        const SizedBox(height: 8),
                        Text("Filename: $filename", style: TextStyle(fontWeight: FontWeight.bold)),
                        ...
                        Row(
                          ...
                          children: [
                            TextButton(
                              onPressed: () async {
                                List<Map<String, dynamic>> documents = await DatabaseHelper().fetchAllDocData();
            ...
            Container(
              ...
              child: FloatingActionButton(
                ...
                onPressed: () {
                 ...
                 // Navigator.push(
                 //   context,
                 //  MaterialPageRoute(builder: (context) => Adddocumentmanager()),
                 //  );
                },
